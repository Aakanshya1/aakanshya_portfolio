...
function About() {
  return (
    ...
    <div className='flex flex-col gap-20 justify-center items-center '>
      {/* about me */}
      <div className='w-[50%]  gap-20 flex flex-col items-center text-center mt-15'>
      <div className='monsterrant font-bold text-[14px] lg:text-[30px] uppercase tracking-[0.5rem] border-8 lg:border-4 w-fit py-4 px-10 items-center'>About Me</div>
...
<div className=" w-full flex flex-col h-100vh justify-center items-center">
  <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 w-[70%] text-left place-items-center">
